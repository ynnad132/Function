...
def convert_annotation(data_dir,imageset,image_id):
    ...
    out_file = open(data_dir+'/%s_label/%s.txt' % (imageset,image_id), 'w') #保存txt
...
data_dir=r'C:\Users\EE803\Desktop\fasterrcnndata\Yolov7\unlabel\train_label'
